...
const AnimatedPathText = ({
  ...
  // Use scroll with a fallback container
  ...
  useEffect(() => {
    // Only set up scroll handler when hydrated and we have scrollYProgress
    if (!isHydrated || !scrollYProgress || !t) return
